	...
	private void addAndMeasureChild(final View child, int viewPos) {
		...
		child.measure(
				MeasureSpec
						.makeMeasureSpec(
								getWidth(),
								params.width == LayoutParams.MATCH_PARENT ? MeasureSpec.EXACTLY
										: MeasureSpec.AT_MOST),
				MeasureSpec
						.makeMeasureSpec(
								getHeight(),
								params.height == LayoutParams.MATCH_PARENT ? MeasureSpec.EXACTLY
										: MeasureSpec.AT_MOST));
	}
			...
			for (int i = 0; i < getChildCount(); i++) {
				...
				if (isEventWithinView(e, child)) {
					if (mOnItemClicked != null) {
						mOnItemClicked.onItemClick(HListView.this, child,
								mLeftViewIndex + 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					if (mOnItemSelected != null) {
						mOnItemSelected.onItemSelected(HListView.this, child,
								mLeftViewIndex + 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					break;
			...
			for (int i = 0; i < childCount; i++) {
				...
				if (isEventWithinView(e, child)) {
					if (mOnItemLongClicked != null) {
						mOnItemLongClicked.onItemLongClick(HListView.this,
